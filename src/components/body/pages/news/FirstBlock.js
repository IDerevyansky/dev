    ...
    return(
        ...
        <>
            ...
            <div className="scroll-pl-6 snap-x newsBlock adpt_m">
                ...
                <div className="snap-center cardNews block-1-3" style={{background:gradientNewsCard + ", url("+ props.data[1].img +") center, center"}}>
                ...
                <div className="snap-center cardNews block-1-3" style={{background:gradientNewsCard + ", url("+ props.data[2].img +") center, center"}}>
                ...
                <div className="snap-center cardNews block-2-3" style={{background:gradientNewsCard + ", url("+ props.data[3].img +") center, center"}}>
                ...
                <div className="snap-center cardNews" style={{background:gradientNewsCard + ", url("+ props.data[4].img +") center, center"}}>
                ...
                <div className="snap-center cardNews" style={{background:gradientNewsCard + ", url("+ props.data[5].img +") center, center"}}>
                ...
                <div className="snap-center cardNews" style={{background:gradientNewsCard + ", url("+ props.data[6].img +") center, center"}}>
